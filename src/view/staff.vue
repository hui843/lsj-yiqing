<template>
    <div id="app">
        ...
        <div class="five">
            <div class="fv-1" style="background-color: skyblue" @click="enter()">
                申请进入
            </div>
            <div class="fv-1" style="background-color: #42b983" @click="leave()">
                申请离开
            </div>
        </div>
    </div>
        ...
        methods:{
            ...
            enter(){
                if(!this.identity){
                    ...
                    this.msg = '您的身体有漾，不予通行';
                    alert(this.msg)
                }else {
                    this.http.post('/api/enter',{
